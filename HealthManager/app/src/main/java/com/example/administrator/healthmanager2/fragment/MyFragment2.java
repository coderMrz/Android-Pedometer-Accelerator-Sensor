 ...
 */
public class MyFragment2 extends Fragment implements ReportAdapter.OnItemClickListener {
    public static String LOG_TAG = MyFragment2.class.getName();
    ...
    private void generateReports(boolean updated) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
             ...
             //   SimpleDateFormat simpleDateFormat = new SimpleDateFormat("MMMMdd", locale);
                SimpleDateFormat simpleDateMonthFormat = new SimpleDateFormat("dd", locale);
    ...
    public void onTitleClicked() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(getContext(), R.style.AppTheme_DatePickerDialog, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                MyFragment2.this.day.set(Calendar.DAY_OF_MONTH, dayOfMonth);
                MyFragment2.this.day.set(Calendar.MONTH, monthOfYear);
                MyFragment2.this.day.set(Calendar.YEAR, year);
                MyFragment2.this.generateReports(false);
                if (isTodayShown() && StepDetectionServiceHelper.isStepDetectionEnabled(getContext())) {
                    bindService();
                }
            }
