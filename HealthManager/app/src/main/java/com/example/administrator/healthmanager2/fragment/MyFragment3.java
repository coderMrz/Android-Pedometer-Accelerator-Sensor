 ...
 * @version 20160606
 */
public class MyFragment3  extends Fragment implements ReportAdapter.OnItemClickListener {
    public static String LOG_TAG = MyFragment3.class.getName();
    ...
    public void onTitleClicked() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(getContext(), R.style.AppTheme_DatePickerDialog, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                MyFragment3.this.day.set(Calendar.DAY_OF_MONTH, dayOfMonth);
                MyFragment3.this.day.set(Calendar.MONTH, monthOfYear);
                MyFragment3.this.day.set(Calendar.YEAR, year);
                MyFragment3.this.generateReports(false);
                if (isTodayShown() && StepDetectionServiceHelper.isStepDetectionEnabled(getContext())) {
                    bindService();
                }
            }
