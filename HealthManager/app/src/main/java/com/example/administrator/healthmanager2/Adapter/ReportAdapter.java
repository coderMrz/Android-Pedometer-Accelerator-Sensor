package com.example.administrator.healthmanager2.Adapter;
...
import com.example.administrator.healthmanager2.Models.ActivityChart;
...
import com.example.administrator.healthmanager2.utils.UnitUtil;
...
public class ReportAdapter extends RecyclerView.Adapter <ReportAdapter.ViewHolder>{
        ...
        switch (viewType) {
            case TYPE_CHART:
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_day_zhu, parent, false);
                vh = new zhuViewHolder(v);
                break;
            //TYPE_CHART
            case TYPE_DAY_CHART:
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_day_zhexian, parent, false);

                vh = new zexianViewHolder(v);
                break;
            case TYPE_SUMMARY:
            default:
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_day, parent, false);
                vh = new dayViewHolder(v);
                break;
        }
        return vh;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case TYPE_CHART:
                ...
                zhuViewHolder barChartViewHolder = (zhuViewHolder) holder;
                ...
                if (barChartXValues.size() > 0 && barChartData.getDisplayedDataType() == ActivityDayChart.DataType.STEPS) {
                    ...
                    chartLineDataSet.setDrawCircles(false);
                    chartLineDataSet.setColor(ContextCompat.getColor(barChartViewHolder.context, R.color.colorAccent), 200);// 设置每条柱子的颜色
                    chartLineDataSet.setDrawValues(false);
                    lineDataSets.add(chartLineDataSet);
                }
            ...
            case TYPE_DAY_CHART:
                ...
                zexianViewHolder chartViewHolder = (zexianViewHolder) holder;
            ...
            case TYPE_SUMMARY:
                ...
                dayViewHolder summaryViewHolder = (dayViewHolder) holder;
    ...
    public class zhuViewHolder extends AbstractChartViewHolder {
    ...
    public class zexianViewHolder extends AbstractChartViewHolder {
        public LineChart mChart;

        public zexianViewHolder(View itemView) {
            super(itemView);
    ...
    public class dayViewHolder extends ViewHolder {
        ...
        public dayViewHolder(View itemView) {
            ...
            mPrevButton = (ImageButton) itemView.findViewById(R.id.backbtn);
            mNextButton = (ImageButton) itemView.findViewById(R.id.onbtn);
    ...
    public abstract class AbstractChartViewHolder extends ViewHolder implements PopupMenu.OnMenuItemClickListener {
        ...
        public void showPopup(View v, Context c) {
            ...
            inflater.inflate(R.menu.menu_change_pic, popup.getMenu());
